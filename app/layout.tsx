...
export const metadata: Metadata = {
  ...
  description:
    "Green Roots — premium clothing, accessories, and gifts available by enquiry.",
  icons: {
  ...
  return (
    <html lang="en" className={montserrat.variable}>
      <head>
        ...
        <Script
          async
          src="https://www.googletagmanager.com/gtag/js?id=AW-17217121782"
          strategy="afterInteractive"
        />
        <Script
          id="google-ads"
      ...
      <body className="[font-family:var(--font-montserrat)] antialiased">
        ...
        <noscript>
          <img
            ...
            width="1"
            style={{ display: "none" }}
            src="https://www.facebook.com/tr?id=1716103702767817&ev=PageView&noscript=1"
            alt=""
          />
        </noscript>
