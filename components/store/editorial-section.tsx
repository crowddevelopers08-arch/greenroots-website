...
export function EditorialSection({ onNav }: Props) {
  return (
    <section className="mx-4 mb-8 grid overflow-hidden rounded-[24px] bg-[#111d12] shadow-[var(--shadow-3)] md:mx-12 md:mb-24 md:min-h-[540px] md:rounded-[28px] lg:grid-cols-2">
      <div className="relative flex flex-col justify-between bg-[#111d12] px-5 py-9 md:px-16 md:py-[72px]">
