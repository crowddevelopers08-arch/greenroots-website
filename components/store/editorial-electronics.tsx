    ...
    <section className="mx-4 mb-6 overflow-hidden rounded-[20px] border border-[#ccd8ce] bg-[#f0f6f0] shadow-[var(--shadow-2)] sm:mb-8 md:mx-12 md:mb-24 md:rounded-[28px] lg:grid lg:grid-cols-2">
      ...
      <Reveal animation="slideRight" duration={700} className="flex flex-col justify-between px-5 py-7 md:px-16 md:py-[72px]">
        <div>
          ...
          <p className="mt-5 max-w-[320px] text-[14.5px] leading-[1.75] text-[#2d4430]">
        ...
        <button
          ...
          className="mt-8 inline-flex w-fit items-center gap-2.5 rounded-full border border-[#b4ccb6] bg-[#1e3d22] px-[26px] py-[13px] text-[13px] font-semibold text-white transition hover:-translate-y-0.5 hover:bg-[#2d5a30] hover:shadow-[var(--shadow-2)] md:mt-12"
        >
          Explore Electronics
