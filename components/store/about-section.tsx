    ...
    <section className="relative mx-4 mb-6 overflow-hidden rounded-[20px] sm:mb-8 md:mx-12 md:mb-24 md:rounded-[32px]">
      ...
      <div className="relative px-5 py-16 sm:px-10 sm:py-20 md:px-16 md:py-28">
        <Reveal animation="fadeInBlur" duration={700}>
          ...
          <h2 className="max-w-[720px] font-[var(--font-montserrat)] text-[clamp(38px,6.5vw,80px)] font-extrabold uppercase leading-[0.95] tracking-[-0.02em] text-white">
            About Us
          </h2>

          <p className="mt-6 max-w-[640px] text-[14.5px] leading-[1.9] text-[rgba(255,255,255,.82)] sm:text-[16px]">
