            ...
            <div className="grid gap-0 lg:grid-cols-[minmax(0,1.05fr)_minmax(340px,420px)]">
              ...
              <div className="flex flex-col justify-between p-6 md:p-8">
                <div>
                  ...
                  <h1 className="mt-3 font-[var(--font-montserrat)] text-[clamp(40px,5vw,64px)] leading-[0.95] tracking-[-0.03em] text-[#0d0c0b]">
                    {product.name}
                  </h1>
                  <p className="mt-4 text-[14px] leading-[1.85] text-[#334836]">
                    {product.desc}
                  </p>

                  <div className="mt-6 grid gap-3 sm:grid-cols-2">
                    <div className="rounded-[22px] border border-[#ccd8ce] bg-[#f0f6f0] px-5 py-4">
                      <div className="text-[10px] font-semibold uppercase tracking-[0.14em] text-[#4a7254]">
                        Category
                      </div>
                ...
                <div className="mt-8 flex flex-col gap-3 sm:flex-row">
                  <button
                    ...
                    className="inline-flex items-center justify-center gap-2 rounded-full bg-[#1e3d22] px-7 py-3.5 text-[13px] font-semibold text-white transition hover:-translate-y-0.5 hover:bg-[#2d5a30]"
                  >
                    Enquire Now
                    <svg width="14" height="14" viewBox="0 0 14 14" fill="none">
                  ...
                  <Link
                    href={`/?category=${getCategorySlug(category)}&subcategory=${encodeURIComponent(slugifySegment(product.sub))}`}
                    className="inline-flex items-center justify-center rounded-full border border-[#ccd8ce] px-7 py-3.5 text-[13px] font-medium text-[#3d5843] transition hover:border-[#7a9e82] hover:text-[#0d0c0b]"
                  >
                    Back to Collection
                  </Link>
                </div>
          ...
          <section className="mt-12">
            <div className="mb-6 flex items-end justify-between gap-4">
              <div>
                ...
                <h2 className="mt-2 font-[var(--font-montserrat)] text-[36px] leading-none text-[#0d0c0b]">
                  More from {category}
                </h2>
              </div>
              <Link href="/" className="hidden text-[12.5px] font-medium text-[#3d5843] transition hover:text-[#0d0c0b] md:inline-flex">
                Back to storefront
              </Link>
            </div>
            ...
            {relatedProducts.length > 0 ? (
              ...
              <div className="rounded-[28px] border border-dashed border-[#c0d2c2] bg-[linear-gradient(180deg,#f6fbf7_0%,#e8f3e9_100%)] px-6 py-10 text-center text-[13px] text-[#4a6652]">
